...
export default function StatsCard({ title, icon, color, children }: StatsCardProps) {
  return (
    <div className="glass-card rounded-xl p-6 relative overflow-hidden group hover:bg-slate-800/80">
      <div className={`absolute top-0 right-0 w-32 h-32 rounded-full blur-[40px] -mr-16 -mt-16 transition-all duration-500 ${glowColors[color]}`} />
